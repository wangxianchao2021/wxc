...
//      simpleAuthorInfo.addStringPermissions(permissionList);  
        ...
        if(null!=currentUsername && "wxc".equals(currentUsername)){  
...
//      }  
        ...
        if("wxc".equals(token.getUsername())){  
            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo("wxc", "123456", this.getName());  
            this.setSession("currentUser", "wxc");  
            return authcInfo;  
